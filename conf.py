...
DEPLOY_COMMANDS = {
    'default': [
        ...
        'rsync -a -e "ssh -o StrictHostKeyChecking=no" --delete www/ matey@man.ubuntu-mate.net:ubuntu-mate.boutique/',
        'rsync -a -e "ssh -o StrictHostKeyChecking=no" --delete www/ matey@yor.ubuntu-mate.net:ubuntu-mate.boutique/',
    ]
}
