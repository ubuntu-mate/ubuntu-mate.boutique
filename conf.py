...
DEPLOY_COMMANDS = {
    'default': [
        ...
        'rsync -av -e "ssh -o StrictHostKeyChecking=no" --progress --delete www/ matey@can.wimpress.io:ubuntu-mate.boutique/',
        'rsync -av -e "ssh -o StrictHostKeyChecking=no" --progress --delete www/ matey@fra.wimpress.io:ubuntu-mate.boutique/',
    ]
}
