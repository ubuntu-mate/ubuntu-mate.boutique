...
BLOG_AUTHOR = "Ubuntu MATE Merchandise Team"  # (translatable)
BLOG_TITLE = "Ubuntu MATE Boutique"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "https://ubuntu-mate.boutique/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "shop@ubuntu-mate.org"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
    ("https://ubuntu-mate.org/about/", "About"),
    ("https://ubuntu-mate.org/blog/", "Blog"),
    ("https://ubuntu-mate.org/community", "Community"),        
    ("https://ubuntu-mate.org/download/", "Download"),
    ("https://ubuntu-mate.org/team/", "Team"),
    ("https://ubuntu-mate.org/donate/", "Donate"),
...
DEPLOY_COMMANDS = [
    'rsync -av --delete /tmp/ubuntu-mate.boutique/output/ www/',
    'scripts/minify.sh',
    'find www -type d -exec chmod 755 {} \;',
    'find www -type f -exec chmod 644 {} \;',
    'rsync -a --delete www/ martin@can.ubuntu-mate.net:Websites/ubuntu-mate.boutique/www/',
    'rsync -a --delete www/ martin@fra.ubuntu-mate.net:Websites/ubuntu-mate.boutique/www/',
    'rsync -a --delete www/ martin@ger.ubuntu-mate.net:Websites/ubuntu-mate.boutique/www/',
    'rsync -a --delete www/ martin@ita.ubuntu-mate.net:Websites/ubuntu-mate.boutique/www/',
]
...
OUTPUT_FOLDER = '/tmp/ubuntu-mate.boutique/output'

# where the "cache" of partial generated content should be located
# default: 'cache'
CACHE_FOLDER = '/tmp/ubuntu-mate.boutique/cache'
